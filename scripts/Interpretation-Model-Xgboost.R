...
# Chargement du modèle, de la recette et du seuil optimal
...
# Application exacte du prétraitement d'entraînement
...
#==========================================================================#
# Utilisation directe de shap.prep sans calcul intermédiaire redondant
